        ...
        <div className="w-full my-10 text-white">
            ...
            <div className="lg:max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 mt-10">
                ...
                <div className="bg-neutral-900/80 p-6 rounded-xl border border-neutral-700">
                    ...
                    <p className="text-xl font-semibold text-amber-400 mt-2">$2.99 <span className="text-gray-400">/month</span></p>
                ...
                <div className="bg-neutral-900/80 p-6 rounded-xl border border-neutral-700 relative">
                    ...
                    <p className="text-xl font-semibold text-amber-400 mt-2">$6.99 <span className="text-gray-400">/month</span></p>
                ...
                <div className="bg-neutral-900/80 p-6 rounded-xl border border-neutral-700 relative">
                    ...
                    <p className="text-xl font-semibold text-amber-400 mt-2">$10.00 <span className="text-gray-400">/month</span></p>
