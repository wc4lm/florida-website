...
export default function AwardApp({ Component, pageProps }) {
  ...
  const NavItems = [
    ...
    },
    {
      ...
      href: "https://discord.gg/8SGBpdBhCq",
    },
    {
      link: true,
      name: "Add Bot",
      ...
      href: "https://discord.com/api/oauth2/authorize?client_id=1286181886946967613&permissions=277028620608&scope=bot%20applications.commands",
    },
    {
      link: true,
      name: "Partners",
